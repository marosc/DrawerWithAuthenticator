...
public class MyAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle getAuthToken(
        ...
        if (!authTokenType.equals(AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS)) {
            ...
            result.putString(AccountManager.KEY_ERROR_MESSAGE, "Unsupported token type");
            return result;
        }
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    User user = AccountGeneral.sServerAuthenticate.userSignIn(account.name, password, authTokenType, mContext);
                    if (user != null) {
